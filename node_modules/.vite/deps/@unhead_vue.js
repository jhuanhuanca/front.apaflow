...
// node_modules/unhead/dist/shared/unhead.eQfSuvE2.mjs
...
function useScript(head, _input, _options) {
  ...
  const loadPromise = new Promise((resolve) => {
    ...
    const unhook = (_a2 = head.hooks) == null ? void 0 : _a2.hook("script:updated", ({ script: script2 }) => {
  ...
  const script = {
    ...
    remove() {
      var _a2, _b2, _c2, _d;
      (_a2 = script._triggerAbortControllers) == null ? void 0 : _a2.forEach((ac) => ac.abort());
      (_b2 = script._triggerAbortControllers) == null ? void 0 : _b2.clear();
      script._triggerPromises = [];
      (_c2 = script._warmupEl) == null ? void 0 : _c2.dispose();
      if (script.entry) {
        script.entry.dispose();
        script.entry = void 0;
        syncStatus("removed");
        (_d = head._scripts) == null ? true : delete _d[id];
        return true;
      }
      return false;
    },
      ...
      if ((typeof trigger === "undefined" || trigger === "client") && !head.ssr || trigger === "server") {
        ...
        const abortPromise = new Promise((resolve) => {
          abortController.signal.addEventListener("abort", () => {
            var _a2;
            (_a2 = script._triggerAbortControllers) == null ? void 0 : _a2.delete(abortController);
            resolve();
          });
        });
...
// node_modules/@unhead/vue/dist/shared/vue.D__tEKct.mjs
function registerVueScopeHandlers(script, scope) {
  ...
  onScopeDispose(() => {
    triggerAbortController == null ? void 0 : triggerAbortController.abort();
  });
}
