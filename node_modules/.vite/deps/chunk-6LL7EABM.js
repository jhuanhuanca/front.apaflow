...
// node_modules/unhead/dist/shared/unhead.CfgPMHXt.mjs
function registerPlugin(head, p) {
  ...
  if (!head.plugins.get(key)) {
    ...
    for (const k in plugin.hooks || {})
      (_a = head.hooks) == null ? void 0 : _a.hook(k, plugin.hooks[k]);
  }
}
function createUnhead(renderer, resolvedOptions = {}) {
  ...
  const head = {
    ...
    push(input, _options) {
      const _i = (_options == null ? void 0 : _options._index) ?? head._entryCount++;
...
// node_modules/@unhead/vue/dist/shared/vue.Kp0sxz0n.mjs
...
// node_modules/unhead/dist/shared/unhead.CUXLLRtV.mjs
function defineHeadPlugin(plugin) {
  return plugin;
}

// node_modules/unhead/dist/shared/unhead.BGFxPGPQ.mjs
var BACKSLASH_RE = /\\/g;
var LT_RE = /</g;
...
// node_modules/unhead/dist/shared/unhead.CH30252c.mjs
...
// node_modules/unhead/dist/shared/unhead.fg-0ge_u.mjs
...
var HasElementTags = /* @__PURE__ */ new Set(["base", "meta", "link", "style", "script", "noscript"]);
var ValidHeadTags = /* @__PURE__ */ new Set(["title", "base", "htmlAttrs", "bodyAttrs", "meta", "link", "style", "script", "noscript"]);
...
// node_modules/unhead/dist/shared/unhead.JWUDzlIs.mjs
var NAMESPACES = {
...
// node_modules/unhead/dist/shared/unhead.A4ndrqqe.mjs
...
// node_modules/unhead/dist/shared/unhead.mB5lMBMV.mjs
...
function callHook(head, hook, ctx) {
  var _a;
  return (_a = head.hooks) == null ? void 0 : _a.callHook(hook, ctx);
}

// node_modules/unhead/dist/shared/unhead.DzSj5qjO.mjs
...
var sortTags2 = (a, b) => a._w === b._w ? a._p - b._p : a._w - b._w;
function dedupeTags(ctx) {
  let hasFlatMeta = false;
  for (const next of ctx.tags.sort(sortTags2)) {
...
function resolveTitleTemplate(ctx, head) {
  ...
  if (!fn)
    return;
  let v = typeof fn === "function" ? fn(title == null ? void 0 : title.textContent) : fn;
  if (typeof v === "string" && !head.plugins.has("template-params"))
    v = v.replace("%s", (title == null ? void 0 : title.textContent) || "");
  if (title) {
...
function sanitizeTags(tags) {
  return tags.filter((t) => {
    ...
    if (tag === "script" && (innerHTML || t.textContent)) {
      ...
      const escape = (content) => isJsonLike ? (typeof content === "string" ? content : JSON.stringify(content)).replace(LT_RE2, "\\u003C") : typeof content === "string" ? content.replace(SCRIPT_END_RE, "<\\/script") : content;
      if (innerHTML)
...
function resolveTags(head, options) {
  const weightFn = (options == null ? void 0 : options.tagWeight) ?? head.resolvedOptions._tagWeight ?? (() => 100);
  ...
  if (hasFlatMeta)
    ctx.tags = ctx.tags.flat().sort(sortTags2);
...
// node_modules/@unhead/vue/dist/shared/vue.CkLIG7eN.mjs
var VueResolver = (_, value) => {
  return isRef(value) ? toValue(value) : value;
};

// node_modules/@unhead/vue/dist/shared/vue.Cn5tnr29.mjs
function injectHead() {
...
// node_modules/@unhead/vue/dist/shared/vue.BIIm5xba.mjs
var VueHeadMixin = {
  created() {
    let source = false;
...
//# sourceMappingURL=chunk-6LL7EABM.js.map
