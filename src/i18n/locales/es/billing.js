export default {
  document: {
    ...
    confirming: 'Confirmando pago con Paddle…',
    paddleOverlay: 'Completa el pago en Paddle. Confirmaremos automáticamente.',
  ...
  pro: {
    ...
    paddleRedirect: 'Serás redirigido al checkout seguro de Paddle…',
    paddleOverlay: 'Si no ves el checkout, haz clic en Reintentar. Debe abrirse el formulario de Paddle.',
